  ...
  return (
    <section className="flex min-h-screen flex-col items-center justify-center px-6 pt-20 text-center">
      <div className="mx-auto max-w-4xl">
        <h1 className="mb-8 text-5xl font-extrabold leading-tight tracking-tight text-primary md:text-6xl lg:text-7xl">
        ...
        <p className="mx-auto mb-12 max-w-2xl text-xl leading-relaxed text-text-secondary md:text-2xl">
        ...
        <button
          onClick={onCtaClick}
          className="rounded-full bg-accent px-10 py-5 text-xl font-semibold text-white shadow-lg transition-all hover:bg-accent-light hover:shadow-xl"
        >
